...
- id: atlas-workflow
  ...
  keywords: Atlas, collect_jsons, query, file, out, empty queries, _filter_jsons, _collect_gse_jsons, _collect_publication_texts, GEO, GSE normalization, publication text, original_datalinks, filter_jsons, harmonize_jsons
