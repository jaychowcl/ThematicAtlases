...
- id: fibrosis-run-script
  ...
  keywords: run_fibrosis_atlas.py, run_fibrosis_discovery.py, discovery only, 1000 publications, no harmonization, --resume, DEBUG, verbose, safe telemetry, periodic progress, request duration, full run, max publications, GEO, dev trace, checkpoints, OntoStore, snomed, ADC, .env, .out, summary
